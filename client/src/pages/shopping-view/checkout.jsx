...
//   const { cartItems } = useSelector((state) => state.shopCart)
//   const { user } = useSelector((state) => state.auth)
//   const { razorpayOrderId, amount, currency } = useSelector((state) => state.shopOrder)
//   const [currentSelectedAddress, setCurrentSelectedAddress] = useState(null)
...
//         initializeRazorpay(data.payload)
//       } else {
...
//         // You should dispatch an action here to update the order status
...
//     <div className="flex flex-col">
//       <div className="relative h-[300px] w-full overflow-hidden">
//         <img src={img || "/placeholder.svg"} className="h-full w-full object-cover object-center" alt="Account" />
//       </div>
//       <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5 p-5">
